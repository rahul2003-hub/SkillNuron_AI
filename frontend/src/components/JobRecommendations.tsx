...
import { MapPin, Briefcase, TrendingUp, ExternalLink, Search, Loader2, RefreshCw, CheckCircle2, Send, SlidersHorizontal, Sparkles } from 'lucide-react';
...
export function JobRecommendations() {
  ...
  const [options, setOptions] = useState({ types: [], canMatchProfile: false });
